    ...
    <>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="absolute top-6 right-8 text-right">
          ...
          <div className="text-sm text-white/90 mt-1 drop-shadow-md">
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] p-8 overflow-y-auto">
              ...
              <div className="space-y-6 text-gray-700">
                <p className="text-base">
                  Um diese Seite als Startseite in Ihrem Browser festzulegen,
                  folgen Sie bitte den Anweisungen für Ihren Browser:
                </p>
                ...
                <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
                  <div className="bg-gray-50 p-4 rounded-xl">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm">
                      ...
                      <li>
                        Unter &quot;Darstellung&quot; finden Sie
                        &quot;Startseite anzeigen&quot;
                      </li>
                      <li>
                        Aktivieren Sie die Option und geben Sie die URL ein
                      </li>
                    </ol>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-xl">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm">
                      ...
                      <li>Wählen Sie &quot;Einstellungen&quot;</li>
                      <li>
                        Unter &quot;Startseite&quot; finden Sie die Optionen
                      </li>
                      <li>
                        Wählen Sie &quot;Benutzerdefinierte Adressen&quot; und
                  ...
                  <div className="bg-gray-50 p-4 rounded-xl">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm">
                      ...
                      <li>Wählen Sie &quot;Einstellungen&quot;</li>
                      <li>
                        Unter &quot;Beim Start&quot; wählen Sie &quot;Diese
                        Seiten öffnen&quot;
                      </li>
                      <li>
                  ...
                  <div className="bg-gray-50 p-4 rounded-xl">
                    ...
                    <ol className="list-decimal list-inside space-y-1 text-sm">
                      ...
                      <li>
                        Unter &quot;Neue Fenster öffnen mit&quot; und &quot;Neue
                        Tabs öffnen mit&quot;
                      </li>
                      <li>
                        Wählen Sie &quot;Homepage&quot; und geben Sie die URL
                        ein
                      </li>
                    </ol>
                  </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 w-full max-w-4xl">
            {shortcuts.map((shortcut) => (
              ...
              >
                <div
                  className={`${shortcut.color} p-4 rounded-2xl shadow-lg
                              group-hover:scale-110 transition-transform duration-200`}
                >
                  <shortcut.icon className="text-white" size={32} />
                </div>
                <span className="mt-3 text-sm font-medium text-white drop-shadow-md">
                  {shortcut.name}
                </span>
              </a>
            ))}
